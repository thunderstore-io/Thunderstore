...
class TeamCreateAPIView(APIView):
    @swagger_auto_schema(
        ...
        responses={200: CyberstormTeamCreateSerialiazer},
...
class EditTeamAPIView(APIView):
    @swagger_auto_schema(
        request_body=CyberstormEditTeamSerialiazer,
        responses={200: CyberstormEditTeamSerialiazer},
...
class CreateServiceAccountAPIView(APIView):
    @swagger_auto_schema(
        request_body=CyberstormCreateServiceAccountRequestSerialiazer,
        responses={200: CyberstormCreateServiceAccountResponseSerialiazer},
        operation_id="cyberstorm.team.service-accounts.create",
        tags=["cyberstorm"],
    )
    def post(self, request, team_id, format=None):
        try:
...
class DeleteServiceAccountAPIView(APIView):
    @swagger_auto_schema(
        request_body=CyberstormDeleteServiceAccountRequestSerialiazer,
        responses={200: CyberstormDeleteServiceAccountResponseSerialiazer},
        operation_id="cyberstorm.team.service-accounts.delete",
        tags=["cyberstorm"],
    )
    def post(self, request, team_id, format=None):
        try:
