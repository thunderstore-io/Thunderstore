...
class APIV1ChunkedPackageCache(SafeDeleteMixin):
    ...
    def drop_stale_cache(cls) -> None:
        ...
        TODO: only soft deletes the parent object until we've figured out
        how to safely delete the blobs from main and mirror storages.

        TODO: ensure dropping of stale caches doesn't fail if any blobs,
        identified by hash of their content, is still used elsewhere.
        """
    ...
    return json.dumps(
        {
            ...
            # TODO: can this contain duplicates or why was set() used elsewhere?
