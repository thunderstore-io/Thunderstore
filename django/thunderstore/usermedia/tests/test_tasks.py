...
from thunderstore.usermedia.tasks import celery_cleanup_expired_uploads


@pytest.mark.django_db
def test_celery_cleanup_expired_uploads() -> None:
    ...
    celery_cleanup_expired_uploads.delay()
