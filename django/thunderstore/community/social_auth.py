...
class CommunitySocialAuthStrategy(DjangoStrategy):
    ...
    def is_discord_configured(self):
        return (
            self.request.community_site
            and self.request.community_site.social_auth_discord_key
            and self.request.community_site.social_auth_discord_secret
        )
    ...
    def is_github_configured(self):
        return (
            self.request.community_site
            and self.request.community_site.social_auth_github_key
            and self.request.community_site.social_auth_github_secret
        )
