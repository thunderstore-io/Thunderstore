...
def test_setup_dev_env_populates_sites_binds_community_and_creates_admin(
    ...
    Site.objects.create(domain="*", name="Wildcard")
    Site.objects.create(domain="example.com", name="Example")
    Site.objects.create(domain="thunderstore.localhost", name="Old Thunderstore")
    Site.objects.create(
        domain="auth.thunderstore.localhost", name="Old Thunderstore Auth"
    )
