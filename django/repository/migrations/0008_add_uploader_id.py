...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="package", name="maintainers"),
        migrations.AlterField(
            model_name="packageversion",
            name="file",
            field=models.FileField(
                storage=backblaze_b2.storage.BackblazeB2Storage(),
                upload_to=repository.models.get_version_zip_filepath,
            ),
        ),
        migrations.AlterUniqueTogether(
            name="uploaderidentitymember", unique_together={("user", "identity")}
        ),
    ]
